...
# Construir la URL de búsqueda de Google Imágenes
my $url = "https://www.google.com/search?tbm=isch&q=$consulta";

# Imprimir una redirección para llevar al usuario a la página de resultados de Google Imágenes
